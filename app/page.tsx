  ...
  return (
    <div className="relative min-h-full px-4 pb-28 pt-6 select-none font-sans">
      ...
      {hydrated && calorieExceeded && (
        <div className="mb-6 mx-auto max-w-sm glass-panel bg-red-950/10 border border-red-500/20 rounded-2xl p-4 flex items-start gap-3 shadow-lg animate-fade-in">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-red-500/10 text-red-400 border border-red-500/20">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="18"
              height="18"
          ...
          <div className="flex-1">
            <h3 className="text-sm font-extrabold text-red-400 uppercase tracking-wider font-sans">
              Surplus Detected
            </h3>
            <p className="mt-0.5 text-xs text-zinc-300 font-semibold leading-relaxed font-sans">
      ...
      {hydrated && (
        <div className="mb-8 flex justify-center">
          <button
            ...
            className="glass-button px-5 py-2 text-xs font-bold text-zinc-300 hover:text-white rounded-full flex items-center gap-1.5 transition active:scale-95 cursor-pointer shadow-md"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="14"
